...
public class TestClusterMapper {
    ...
    public void testAddCluster() {
        ClusterEntity clusterEntity =
            new ClusterEntity(null, "cl1", "registryList", "server", "1.7.0", "null", "null", "null", "no", 0, 0, 0, null, null, 0);
    ...
    public void testSelectAllCluster() {
        ...
        ClusterEntity clusterEntity1 =
            new ClusterEntity(null, "c1", "registryList", "server", "1.7.0", "null", "null", "null", "no", 0, 0, 0, null, null, 0);
        clusterMapper.addCluster(clusterEntity);
